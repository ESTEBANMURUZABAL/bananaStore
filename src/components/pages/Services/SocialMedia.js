      ...
      <div>
        ...
        <div className="snip1265">
          ...
          <div className="plan">
            ...
            <div className="plan-select"><Link to="/services/socialPack4"><FormattedMessage message={intlStore.getMessage(intlData, 'selectPlan')} locales={intlStore.getCurrentLocale()} /></Link></div>
          </div>
