                ...
                <div className="info-page__content">
                    <div className="info-page__block">
                        ...
                        <div className="info-page__support">
                            <p>
                                Para qualquer problema relativo com a loja online, p.f. contactar através de <a href="mailto:vendas@bananaCat.com">vendas@bananaCat.com</a><br />
                                Obrigado
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="info-page__block">
                        ...
                        <div className="info-page__terms-and-conditions">
                            ...
                            <p>
                                ...
                                1.1 Os produtos bananaCat presentes no nosso catálogo on-line e os serviços comerciais previstos estão disponíveis exclusivamente para os seus utilizadores finais, ou seja os “Consumidores”. Os nossos produtos e respectivos preços são válidos se desde que estejam disponíveis nos nossos armazéns.<br />
                                ...
                                1.3 A bananaCat ES reserva-se o direito de não processar encomendas recebidas de utilizadores que não sejam “Consumidores” e qualquer outra encomenda que não cumpra a política comercial da bananaCat Portugal.<br />
                                1.4 Os presentes Termos e Condições Gerais de Venda regulam exclusivamente a oferta, transmissão e aceitação de encomendas de compra relativas a produtos existentes na loja online da bananaCat ES entre os utilizadores da bananaCat ES e a empresa bananaCat ES.<br />
                                1.5 Os Termos e Condições Gerais de Venda não regulam o fornecimento de serviços ou a venda de produtos por parte de terceiros que estejam em bananaCat Portugal através de ligações, banners ou outras ligações de hipertexto. Antes de enviar encomendas e adquirir produtos e serviços a estes terceiros, recomendamos aos nossos utilizadores que verifiquem os termos e condições destes, uma vez que a bananaCat Portugal não pode, em circunstância alguma, ser responsabilizada pelo fornecimento de serviços prestados por terceiros ou pela execução de transacções de comércio electrónico entre utilizadores de bananaCat Portugal e terceiros.
                            </p>
                            <p>
                                <strong>2. Como celebrar um contrato com bananaCat ES</strong><br />
                                2.1 Para solicitar uma encomenda relativa à aquisição de um ou vários produtos em bananaCat ES, deverá escolher os mesmos na loja online e preencher o formulário de encomenda que é electronicamente enviado para a plataforma alugada para o efeito, seguindo as instruções relevantes ao adicionar um produto ao cesto, ficando a sua compra registada.<br />
                                ...
                                2.3 Considera-se que uma encomenda foi efectuada quando bananaCat ES tenha recebido o seu formulário de encomenda por via electrónica e a informação tenha sido verificada e dada como correcta.<br />
                                ...
                                2.6 As encomendas submetidas a bananaCat ES têm de ser preenchidas em Português, Inglês ou Espanhol, de acordo com o país para onde será enviada a encomenda.<br />
                                2.7 Depois do seu formulário de encomenda ter sido registado, bananaCat ES processará a sua encomenda logo que possível.<br />
                                2.9 bananaCat ES pode não processar pedidos de compra se não houver garantias suficientes de solvabilidade, se as encomendas estiverem incompletas ou incorrectas, ou se os produtos já não estiverem disponíveis. Nas situações acima referidas, informaremos por e-mail que o contrato não foi executado e que bananaCat ES não efectuou a sua encomenda especificando os motivos. Para além das informações fornecidas, bananaCat ES não se encontra nas condições de dar-vos indicações mais detalhadas em relação à disponibilidade do (s) produto (s); portanto uma vez examinada a sua encomenda, bananaCat ES informar-lhe-á através de email ou telefonicamente se alguns dos produtos encomendados por si não estiverem disponíveis. Ressalvadas as disposições das Condições Gerais de Venda, considera-se que a encomenda em questão tem por objecto prestações de venda divisíveis, autónomas e relativas a mais do que uma unidade económica, tantas quantos são os produtos encomendados, tal como foi expressamente concordado entre o Cliente e bananaCat ES com o envio da encomenda e a aceitação da mesma. Consequentemente, no caso em que a execução da encomenda por parte de bananaCat ES seja limitada a alguns dos produtos encomendados devido à indisponibilidade de alguns desses ou por outras razões legítimas, independentes da vontade de bananaCat ES, com o envio da encomenda em questão, o Comprador declara o seu interesse e presta o seu consentimento à execução parcial da compra, limitada aos produtos restantes, que portanto não poderá ser recusada por parte do Comprador, nem poderá consentir ao Comprador a rescisão da referida encomenda. No caso bananaCat ES não se encontre nas condições de aceitar integralmente a encomenda efectuada pelo Cliente, dando origem à aceitação parcial da mesma relativamente aos produtos disponíveis, o eventual exercício do direito de arrependimento previsto pelo art. n° 8 das Condições Gerais de Venda não dará origem a nenhuma despesa de transporte a cargo do próprio Cliente.<br />
                                2.10 A submissão de um formulário de encomenda a bananaCat ES significa a aceitação incondicional e compromisso de observar as disposições dos presentes Termos e Condições Gerais de Venda no contrato que celebra com bananaCat ES. Caso não concorde com algumas das disposições dos presentes Termos e Condições Gerais de Venda, não submeta o seu formulário de encomenda para aquisição de produtos em bananaCat ES e contacte-nos.<br />
                                2.11 Ao submeter um formulário de encomenda, está a aceitar e concordar com os presentes Termos e Condições Gerais de Venda bem como com outras condições igualmente contidas em bananaCat ES através de ligações, incluindo os Termos e Condições Gerais de Venda e Política de Privacidade<br />
                                2.12 Uma vez submetido um formulário de encomenda, bananaCat ES envia-lhe, por e-mail cópia do recibo electrónico da ordem de compra, contendo um resumo da informação relacionada com o formulário de encomenda (Principais características dos produtos, informação detalhada sobre o preço, condições de pagamento e o custo do pedido de expedição para o cliente, endereço onde apresentar eventuais reclamações e serviços de assistência pós-venda).<br />
                                2.13 Ao submeter um formulário de encomenda à bananaCat ES, está a aceitar receber a factura/talão emitidos para efeitos fiscais em formato Físico conjuntamente com a encomenda efectuada.
                            </p>
                            <p>
                                <strong>3. Garantias e Indicação do Preço do Produto</strong><br />
                                3.1 Os produtos para venda em bananaCat ES são de qualidade superior, de acordo com os standards europeus, depois de passados pelos testes de qualidade. Estes testes são supervisionados pela bananaCat GMBH.<br />
                                3.2 As principais características dos produtos são apresentadas na bananaCat ES na página web de cada produto. Os produtos oferecidos para venda na bananaCat ES podem não corresponder exactamente ao real em termos de imagem e cores devido ao browser da Internet ou ao monitor usados. As imagens apresentadas têm um efeito meramente indicativo. As características técnicas de um produto, as homologações e declarações de segurança de um produto de marca bananaCat ES e de qualquer outro produto vendido através do sítio são indicadas na etiqueta ou na embalagem ou nas instruções de utilização do produto e podem estar referidas na totalidade ou em parte no próprio sítio junto da ilustração do Produto. Todos os produtos de marca bananaCat ES respeitam os standards e estão homologados conforme quanto previsto pelas normas da Comunidade Europeia.<br />
