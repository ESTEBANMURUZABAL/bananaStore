          ...
          <div className="contact-wrapper">
            ...
            <div>
                ...
                <ul className="contact-list">
                  <li className="list-item"><i className="fa fa-check-square fa-2x"><span className="contact-text place"><FormattedMessage message={intlStore.getMessage(intlData, 'mobilePack2Feature1')} /></span></i></li>
                  <li className="list-item"><i className="fa fa-check-square fa-2x"><span className="contact-text phone"><FormattedMessage message={intlStore.getMessage(intlData, 'mobilePack2Feature2')} /></span></i></li>
                  <li className="list-item"><i className="fa fa-check-square fa-2x"><span className="contact-text gmail"><FormattedMessage message={intlStore.getMessage(intlData, 'mobilePack2Feature3')} /></span></i></li>
                  <li className="list-item"><i className="fa fa-check-square fa-2x"><span className="contact-text gmail"><FormattedMessage message={intlStore.getMessage(intlData, 'mobilePack2Feature4')} /></span></i></li>
                  <li className="list-item"><i className="fa fa-check-square fa-2x"><span className="contact-text gmail"><FormattedMessage message={intlStore.getMessage(intlData, 'mobilePack2Feature5')} /></span></i></li>
                  <li className="list-item"><i className="fa fa-check-square fa-2x"><span className="contact-text gmail"><FormattedMessage message={intlStore.getMessage(intlData, 'mobilePack2Feature6')} /></span></i></li>
                </ul>
              </div>
            </div>
