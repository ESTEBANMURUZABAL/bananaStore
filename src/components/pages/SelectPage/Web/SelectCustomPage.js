...
export default class SelectCustomPage extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    ...
    let linkParamsTemplate1 = Object.assign({packNum: 'webPack4',templateId: 'template-1'}, routeParams);
    let linkParamsTemplate2 = Object.assign({packNum: 'webPack4',templateId: 'template-2'}, routeParams);
    let linkParamsTemplate3 = Object.assign({packNum: 'webPack4',templateId: 'template-3'}, routeParams);
    let linkParamsTemplate4 = Object.assign({packNum: 'webPack4',templateId: 'template-4'}, routeParams);
    let linkParamsTemplate5 = Object.assign({packNum: 'webPack4',templateId: 'template-5'}, routeParams);
    let linkParamsTemplate6 = Object.assign({packNum: 'webPack4',templateId: 'template-6'}, routeParams);
